...
namespace vulkan{
	...
	public:
		explicit RenderPass(const Array<Texture*> &images, const Array<string> &options = {});
		explicit RenderPass(const Array<string> &formats, const Array<string> &options = {});
		explicit RenderPass(const Array<VkFormat> &formats, const Array<string> &options = {});
		~RenderPass();
