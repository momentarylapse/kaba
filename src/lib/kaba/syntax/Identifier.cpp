...
const string IDENTIFIER_FUNC_DELETE_OVERRIDE = "__del_override__";
...
const string IDENTIFIER_FUNC_CALL = "call";
...
const string IDENTIFIER_FUNC_OPTIONAL_HAS_VALUE = "has_value";
const string IDENTIFIER_FUNC_OPTIONAL_VALUE = "value";
...
const string IDENTIFIER_TYPEOF = "typeof";
...
const string IDENTIFIER_REF = "ref";
