...
enum class NodeKind {
	...
	SPECIAL_FUNCTION,   // = len(), sorted() etc
...
shared<Node> add_node_special_function(SpecialFunctionID id, int token_id = -1, const Class *type = TypeVoid);//, const shared_array<Node> &params);
