...
extern const string IDENTIFIER_FUNC_DELETE_OVERRIDE;
...
extern const string IDENTIFIER_FUNC_CALL;
...
extern const string IDENTIFIER_FUNC_OPTIONAL_VALUE;
...
extern const string IDENTIFIER_REF;
...
extern const string IDENTIFIER_NOFRAME;
