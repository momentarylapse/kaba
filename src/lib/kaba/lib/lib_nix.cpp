...
void SIAddPackageNix() {
	...
	add_func("StartFrameHui", TypeVoid, nix_p(&nix::StartFrameHui), Flags::STATIC);
	add_func("EndFrameHui", TypeVoid, nix_p(&nix::EndFrameHui), Flags::STATIC);
	add_func("BindFrameBuffer", TypeVoid, nix_p(&nix::BindFrameBuffer), Flags::STATIC);
		func_add_param("fb", TypeFrameBuffer);
	add_func("SetViewport", TypeVoid, nix_p(&nix::SetViewport), Flags::STATIC);
		func_add_param("r", TypeRect);
	add_func("ResetToColor", TypeVoid, nix_p(&nix::ResetToColor), Flags::STATIC);
		func_add_param("c", TypeColor);
	add_func("SetWorldMatrix", TypeVoid, nix_p(&nix::SetWorldMatrix), Flags::STATIC);
		func_add_param("m", TypeMatrix);
	add_func("DrawTriangles", TypeVoid, nix_p(&nix::DrawTriangles), Flags::STATIC);
		func_add_param("vb", TypeVertexBuffer);
	add_func("DrawLines", TypeVoid, nix_p(&nix::DrawLines), Flags::STATIC);
		func_add_param("vb", TypeVertexBuffer);
		func_add_param("contiguous", TypeBool);
	add_func("SetAlphaM", TypeVoid, nix_p(&nix::SetAlphaM), Flags::STATIC);
		func_add_param("mode", TypeInt);
	add_func("SetAlphaSD", TypeVoid, nix_p(&nix::SetAlphaSD), Flags::STATIC);
		func_add_param("source", TypeInt);
		func_add_param("dest", TypeInt);
	add_func("SetStencil", TypeVoid, nix_p(&nix::SetStencil), Flags::STATIC);
		func_add_param("mode", TypeInt);
		func_add_param("param", TypeInt);
	add_func("SetProjectionPerspective", TypeVoid, nix_p(&nix::SetProjectionPerspective), Flags::STATIC);
	add_func("SetProjectionPerspectiveExt", TypeVoid, nix_p(&nix::SetProjectionPerspectiveExt), Flags::STATIC);
	...
	add_func("SetProjectionOrtho", TypeVoid, nix_p(&nix::SetProjectionOrtho), Flags::STATIC);
		func_add_param("relative", TypeBool);
	add_func("SetProjectionOrthoExt", TypeVoid, nix_p(&nix::SetProjectionOrthoExt), Flags::STATIC);
		func_add_param("centerx", TypeFloat32);
		func_add_param("centery", TypeFloat32);
		...
		func_add_param("zmin", TypeFloat32);
		func_add_param("zmax", TypeFloat32);
	add_func("SetProjectionMatrix", TypeVoid, nix_p(&nix::SetProjectionMatrix), Flags::STATIC);
		func_add_param("m", TypeMatrix);
	add_func("SetViewMatrix", TypeVoid, nix_p(&nix::SetViewMatrix), Flags::STATIC);
		func_add_param("view_mat", TypeMatrix);
	add_func("SetScissor", TypeVoid, nix_p(&nix::SetScissor), Flags::STATIC);
		func_add_param("r", TypeRect);
	add_func("SetZ", TypeVoid, nix_p(&nix::SetZ), Flags::STATIC);
		func_add_param("write", TypeBool);
		func_add_param("test", TypeBool);
	add_func("SetCull", TypeVoid, nix_p(&nix::SetCull), Flags::STATIC);
		func_add_param("mode", TypeInt);
	add_func("SetWire", TypeVoid, nix_p(&nix::SetWire), Flags::STATIC);
		func_add_param("enabled", TypeBool);
	add_func("SetMaterial", TypeVoid, nix_p(&nix::SetMaterial), Flags::STATIC);
	...
	add_func("SetTexture", TypeVoid, nix_p(&nix::SetTexture), Flags::STATIC);
		func_add_param("t", TypeTexture);
	add_func("SetTextures", TypeVoid, nix_p(&nix::SetTextures), Flags::STATIC);
		func_add_param("t", TypeTexturePList);
	add_func("SetShader", TypeVoid, nix_p(&nix::SetShader), Flags::STATIC);
		func_add_param("s", TypeShader);
	add_func("BindUniform", TypeVoid, nix_p(mf(&nix::BindUniform)), Flags::STATIC);
		func_add_param("buf", TypeUniformBuffer);
		func_add_param("binding", TypeInt);
	add_func("ScreenShotToImage", TypeVoid, nix_p(&nix::ScreenShotToImage), Flags::STATIC);
