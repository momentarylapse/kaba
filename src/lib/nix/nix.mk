...
NIX_OBJ  = $(NIX_DIR)/nix.o $(NIX_DIR)/nix_draw.o $(NIX_DIR)/nix_view.o $(NIX_DIR)/nix_input.o $(NIX_DIR)/nix_textures.o \
...
$(NIX_DIR)/nix_input.o : $(NIX_DIR)/nix_input.cpp
	$(CPP) -c $(NIX_DIR)/nix_input.cpp -o $@ $(NIX_CXXFLAGS)
...
$(NIX_DIR)/nix_input.cpp : $(NIX_DIR)/nix.h
$(NIX_DIR)/nix_net.cpp : $(NIX_DIR)/nix.h
$(NIX_DIR)/nix.h : $(LIB_DIR)/config.h $(NIX_DIR)/nix_config.h $(NIX_DIR)/nix_draw.h $(NIX_DIR)/nix_view.h $(NIX_DIR)/nix_input.h $(NIX_DIR)/nix_textures.h
