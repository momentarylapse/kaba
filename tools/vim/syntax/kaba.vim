...
syn keyword kabaKeyword class struct func if then else for while in return break continue enum lambda use import const extern static virtual override selfref ref let dyn sort call raise try except and or not len str new del out throws pure extends shared owned as is var _filter weak
